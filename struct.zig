pub const Command = packed struct { tag: u8, 
    // Does nothing.
    nop: packed struct {
...
//  NO_MUSIC = FALSE
    ...
    trainerbattle_single: packed struct {
...
//  .elseif \music == TRUE
    ...
    trainerbattle_double: packed struct {
//  .if \event_script == FALSE
...
//  .elseif \music == TRUE
    ...
    trainerbattle_rematch: packed struct {
    ...
    trainerbattle_rematch_double: packed struct {
    ...
    trainerbattle_no_intro: packed struct {
...
// Supplementary
    ...
    goto_if_unset: packed struct {
    checkflag \flag
    goto_if 0, \dest
    },

    goto_if_set: packed struct {
    checkflag \flag
    goto_if 1, \dest
    },

    goto_if_lt: packed struct {
    goto_if 0, \dest
    },

    goto_if_eq: packed struct {
    goto_if 1, \dest
    },

    goto_if_gt: packed struct {
    goto_if 2, \dest
    },

    goto_if_le: packed struct {
    goto_if 3, \dest
    },

    goto_if_ge: packed struct {
    goto_if 4, \dest
    },

    goto_if_ne: packed struct {
    goto_if 5, \dest
    },

    call_if_unset: packed struct {
    checkflag \flag
    call_if 0, \dest
    },

    call_if_set: packed struct {
    checkflag \flag
    call_if 1, \dest
    },

    call_if_lt: packed struct {
    call_if 0, \dest
    },

    call_if_eq: packed struct {
    call_if 1, \dest
    },

    call_if_gt: packed struct {
    call_if 2, \dest
    },

    call_if_le: packed struct {
    call_if 3, \dest
    },

    call_if_ge: packed struct {
    call_if 4, \dest
    },

    call_if_ne: packed struct {
    call_if 5, \dest
    },

    switch: packed struct {
...
//  NO  = 0
    ...
    msgbox: packed struct {
    loadword 0, \text
    callstd \type
    },

    giveitem_std: packed struct {
    setorcopyvar VAR_0x8000, \item
    setorcopyvar VAR_0x8001, \amount
    callstd \function
    },

    givedecoration_std: packed struct {
    setorcopyvar VAR_0x8000, \decoration
    callstd STD_OBTAIN_DECORATION
    },

    register_matchcall: packed struct {
