...
pub const Command = extern union {
    ...
    pub const Kind = enum(u16) {
        nop0 = @enumToInt(lu16.init(0x0)),
        nop1 = @enumToInt(lu16.init(0x1)),
        end = @enumToInt(lu16.init(0x2)),
        return2 = @enumToInt(lu16.init(0x3)),
        cmd_a = @enumToInt(lu16.init(0xa)),
        @"if" = @enumToInt(lu16.init(0x11)),
        if2 = @enumToInt(lu16.init(0x12)),
        call_standard = @enumToInt(lu16.init(0x14)),
        exit_standard = @enumToInt(lu16.init(0x15)),
        jump = @enumToInt(lu16.init(0x16)),
        call = @enumToInt(lu16.init(0x1a)),
        @"return" = @enumToInt(lu16.init(0x1b)),
        compare_last_result_jump = @enumToInt(lu16.init(0x1c)),
        compare_last_result_call = @enumToInt(lu16.init(0x1d)),
        set_flag = @enumToInt(lu16.init(0x1e)),
        clear_flag = @enumToInt(lu16.init(0x1f)),
        check_flag = @enumToInt(lu16.init(0x20)),
        cmd_21 = @enumToInt(lu16.init(0x21)),
        cmd_22 = @enumToInt(lu16.init(0x22)),
        set_trainer_id = @enumToInt(lu16.init(0x23)),
        cmd_24 = @enumToInt(lu16.init(0x24)),
        clear_trainer_id = @enumToInt(lu16.init(0x25)),
        script_cmd__add_value = @enumToInt(lu16.init(0x26)),
        script_cmd__sub_value = @enumToInt(lu16.init(0x27)),
        set_var = @enumToInt(lu16.init(0x28)),
        copy_var = @enumToInt(lu16.init(0x29)),
        message2 = @enumToInt(lu16.init(0x2b)),
        message = @enumToInt(lu16.init(0x2c)),
        message3 = @enumToInt(lu16.init(0x2d)),
        message4 = @enumToInt(lu16.init(0x2e)),
        message5 = @enumToInt(lu16.init(0x2f)),
        cmd_30 = @enumToInt(lu16.init(0x30)),
        wait_button = @enumToInt(lu16.init(0x31)),
        cmd_32 = @enumToInt(lu16.init(0x32)),
        cmd_33 = @enumToInt(lu16.init(0x33)),
        close_msg_on_key_press = @enumToInt(lu16.init(0x34)),
        freeze_message_box = @enumToInt(lu16.init(0x35)),
        call_message_box = @enumToInt(lu16.init(0x36)),
        color_msg_box = @enumToInt(lu16.init(0x37)),
        type_message_box = @enumToInt(lu16.init(0x38)),
        no_map_message_box = @enumToInt(lu16.init(0x39)),
        call_text_msg_box = @enumToInt(lu16.init(0x3a)),
        store_menu_status = @enumToInt(lu16.init(0x3b)),
        show_menu = @enumToInt(lu16.init(0x3c)),
        yes_no_box = @enumToInt(lu16.init(0x3e)),
        multi = @enumToInt(lu16.init(0x40)),
        multi2 = @enumToInt(lu16.init(0x41)),
        cmd_42 = @enumToInt(lu16.init(0x42)),
        close_multi = @enumToInt(lu16.init(0x43)),
        multi3 = @enumToInt(lu16.init(0x44)),
        multi4 = @enumToInt(lu16.init(0x45)),
        txt_msg_scrp_multi = @enumToInt(lu16.init(0x46)),
        close_multi4 = @enumToInt(lu16.init(0x47)),
        play_fanfare = @enumToInt(lu16.init(0x49)),
        multi_row = @enumToInt(lu16.init(0x48)),
        play_fanfare2 = @enumToInt(lu16.init(0x4a)),
        wait_fanfare = @enumToInt(lu16.init(0x4b)),
        play_cry = @enumToInt(lu16.init(0x4c)),
        wait_cry = @enumToInt(lu16.init(0x4d)),
        soundfr = @enumToInt(lu16.init(0x4e)),
        cmd_4f = @enumToInt(lu16.init(0x4f)),
        play_sound = @enumToInt(lu16.init(0x50)),
        stop = @enumToInt(lu16.init(0x51)),
        restart = @enumToInt(lu16.init(0x52)),
        cmd_53 = @enumToInt(lu16.init(0x53)),
        switch_music = @enumToInt(lu16.init(0x54)),
        store_saying_learned = @enumToInt(lu16.init(0x55)),
        play_sound2 = @enumToInt(lu16.init(0x57)),
        cmd_58 = @enumToInt(lu16.init(0x58)),
        check_saying_learned = @enumToInt(lu16.init(0x59)),
        swith_music2 = @enumToInt(lu16.init(0x5a)),
        act_microphone = @enumToInt(lu16.init(0x5b)),
        deact_microphone = @enumToInt(lu16.init(0x5c)),
        cmd_5d = @enumToInt(lu16.init(0x5d)),
        apply_movement = @enumToInt(lu16.init(0x5e)),
        wait_movement = @enumToInt(lu16.init(0x5f)),
        lock_all = @enumToInt(lu16.init(0x60)),
        release_all = @enumToInt(lu16.init(0x61)),
        lock = @enumToInt(lu16.init(0x62)),
        release = @enumToInt(lu16.init(0x63)),
        add_people = @enumToInt(lu16.init(0x64)),
        remove_people = @enumToInt(lu16.init(0x65)),
        lock_cam = @enumToInt(lu16.init(0x66)),
        zoom_cam = @enumToInt(lu16.init(0x67)),
        face_player = @enumToInt(lu16.init(0x68)),
        check_sprite_position = @enumToInt(lu16.init(0x69)),
        check_person_position = @enumToInt(lu16.init(0x6b)),
        continue_follow = @enumToInt(lu16.init(0x6c)),
        follow_hero = @enumToInt(lu16.init(0x6d)),
        take_money = @enumToInt(lu16.init(0x70)),
        check_money = @enumToInt(lu16.init(0x71)),
        show_money = @enumToInt(lu16.init(0x72)),
        hide_money = @enumToInt(lu16.init(0x73)),
        update_money = @enumToInt(lu16.init(0x74)),
        show_coins = @enumToInt(lu16.init(0x75)),
        hide_coins = @enumToInt(lu16.init(0x76)),
        update_coins = @enumToInt(lu16.init(0x77)),
        check_coins = @enumToInt(lu16.init(0x78)),
        give_coins = @enumToInt(lu16.init(0x79)),
        take_coins = @enumToInt(lu16.init(0x7a)),
        take_item = @enumToInt(lu16.init(0x7b)),
        give_item = @enumToInt(lu16.init(0x7c)),
        check_store_item = @enumToInt(lu16.init(0x7d)),
        check_item = @enumToInt(lu16.init(0x7e)),
        store_item_taken = @enumToInt(lu16.init(0x7f)),
        store_item_type = @enumToInt(lu16.init(0x80)),
        send_item_type1 = @enumToInt(lu16.init(0x83)),
        cmd_84 = @enumToInt(lu16.init(0x84)),
        check_underground_pc_status = @enumToInt(lu16.init(0x85)),
        cmd_86 = @enumToInt(lu16.init(0x86)),
        send_item_type2 = @enumToInt(lu16.init(0x87)),
        cmd_88 = @enumToInt(lu16.init(0x88)),
        cmd_89 = @enumToInt(lu16.init(0x89)),
        cmd_8a = @enumToInt(lu16.init(0x8a)),
        cmd_8b = @enumToInt(lu16.init(0x8b)),
        cmd_8c = @enumToInt(lu16.init(0x8c)),
        cmd_8d = @enumToInt(lu16.init(0x8d)),
        cmd_8e = @enumToInt(lu16.init(0x8e)),
        send_item_type3 = @enumToInt(lu16.init(0x8f)),
        check_pokemon_party = @enumToInt(lu16.init(0x93)),
        store_pokemon_party = @enumToInt(lu16.init(0x94)),
        set_pokemon_party_stored = @enumToInt(lu16.init(0x95)),
        give_pokemon = @enumToInt(lu16.init(0x96)),
        give_egg = @enumToInt(lu16.init(0x97)),
        check_move = @enumToInt(lu16.init(0x99)),
        check_place_stored = @enumToInt(lu16.init(0x9a)),
        cmd_9b = @enumToInt(lu16.init(0x9b)),
        cmd_9c = @enumToInt(lu16.init(0x9c)),
        cmd_9d = @enumToInt(lu16.init(0x9d)),
        cmd_9e = @enumToInt(lu16.init(0x9e)),
        cmd_9f = @enumToInt(lu16.init(0x9f)),
        cmd_a0 = @enumToInt(lu16.init(0xa0)),
        call_end = @enumToInt(lu16.init(0xa1)),
        cmd__a2 = @enumToInt(lu16.init(0xa2)),
        wfc_ = @enumToInt(lu16.init(0xa3)),
        cmd_a4 = @enumToInt(lu16.init(0xa4)),
        interview = @enumToInt(lu16.init(0xa5)),
        dress_pokemon = @enumToInt(lu16.init(0xa6)),
        display_dressed_pokemon = @enumToInt(lu16.init(0xa7)),
        display_contest_pokemon = @enumToInt(lu16.init(0xa8)),
        open_ball_capsule = @enumToInt(lu16.init(0xa9)),
        open_sinnoh_maps = @enumToInt(lu16.init(0xaa)),
        open_pc_function = @enumToInt(lu16.init(0xab)),
        draw_union = @enumToInt(lu16.init(0xac)),
        trainer_case_union = @enumToInt(lu16.init(0xad)),
        trade_union = @enumToInt(lu16.init(0xae)),
        record_mixing_union = @enumToInt(lu16.init(0xaf)),
        end_game = @enumToInt(lu16.init(0xb0)),
        hall_fame_anm = @enumToInt(lu16.init(0xb1)),
        store_wfc_status = @enumToInt(lu16.init(0xb2)),
        start_wfc = @enumToInt(lu16.init(0xb3)),
        choose_starter = @enumToInt(lu16.init(0xb4)),
        battle_starter = @enumToInt(lu16.init(0xb5)),
        battle_id = @enumToInt(lu16.init(0xb6)),
        set_var_battle = @enumToInt(lu16.init(0xb7)),
        check_battle_type = @enumToInt(lu16.init(0xb8)),
        set_var_battle2 = @enumToInt(lu16.init(0xb9)),
        choose_poke_nick = @enumToInt(lu16.init(0xbb)),
        fade_screen = @enumToInt(lu16.init(0xbc)),
        reset_screen = @enumToInt(lu16.init(0xbd)),
        warp = @enumToInt(lu16.init(0xbe)),
        rock_climb_animation = @enumToInt(lu16.init(0xbf)),
        surf_animation = @enumToInt(lu16.init(0xc0)),
        waterfall_animation = @enumToInt(lu16.init(0xc1)),
        flash_animation = @enumToInt(lu16.init(0xc3)),
        defog_animation = @enumToInt(lu16.init(0xc4)),
        prep_hm_effect = @enumToInt(lu16.init(0xc5)),
        tuxedo = @enumToInt(lu16.init(0xc6)),
        check_bike = @enumToInt(lu16.init(0xc7)),
        ride_bike = @enumToInt(lu16.init(0xc8)),
        ride_bike2 = @enumToInt(lu16.init(0xc9)),
        give_poke_hiro_anm = @enumToInt(lu16.init(0xcb)),
        stop_give_poke_hiro_anm = @enumToInt(lu16.init(0xcc)),
        set_var_hero = @enumToInt(lu16.init(0xcd)),
        set_variable_rival = @enumToInt(lu16.init(0xce)),
        set_var_alter = @enumToInt(lu16.init(0xcf)),
        set_var_poke = @enumToInt(lu16.init(0xd0)),
        set_var_item = @enumToInt(lu16.init(0xd1)),
        set_var_item_num = @enumToInt(lu16.init(0xd2)),
        set_var_atk_item = @enumToInt(lu16.init(0xd3)),
        set_var_atk = @enumToInt(lu16.init(0xd4)),
        set_variable_number = @enumToInt(lu16.init(0xd5)),
        set_var_poke_nick = @enumToInt(lu16.init(0xd6)),
        set_var_obj = @enumToInt(lu16.init(0xd7)),
        set_var_trainer = @enumToInt(lu16.init(0xd8)),
        set_var_wi_fi_sprite = @enumToInt(lu16.init(0xd9)),
        set_var_poke_stored = @enumToInt(lu16.init(0xda)),
        set_var_str_hero = @enumToInt(lu16.init(0xdb)),
        set_var_str_rival = @enumToInt(lu16.init(0xdc)),
        store_starter = @enumToInt(lu16.init(0xde)),
        cmd_df = @enumToInt(lu16.init(0xdf)),
        set_var_item_stored = @enumToInt(lu16.init(0xe0)),
        set_var_item_stored2 = @enumToInt(lu16.init(0xe1)),
        set_var_swarm_poke = @enumToInt(lu16.init(0xe2)),
        check_swarm_poke = @enumToInt(lu16.init(0xe3)),
        start_battle_analysis = @enumToInt(lu16.init(0xe4)),
        trainer_battle = @enumToInt(lu16.init(0xe5)),
        endtrainer_battle = @enumToInt(lu16.init(0xe6)),
        trainer_battle_stored = @enumToInt(lu16.init(0xe7)),
        trainer_battle_stored2 = @enumToInt(lu16.init(0xe8)),
        check_trainer_status = @enumToInt(lu16.init(0xe9)),
        store_league_trainer = @enumToInt(lu16.init(0xea)),
        lost_go_pc = @enumToInt(lu16.init(0xeb)),
        check_trainer_lost = @enumToInt(lu16.init(0xec)),
        check_trainer_status2 = @enumToInt(lu16.init(0xed)),
        store_poke_party_defeated = @enumToInt(lu16.init(0xee)),
        chs_friend = @enumToInt(lu16.init(0xf2)),
        wire_battle_wait = @enumToInt(lu16.init(0xf3)),
        cmd_f6 = @enumToInt(lu16.init(0xf6)),
        pokecontest = @enumToInt(lu16.init(0xf7)),
        start_ovation = @enumToInt(lu16.init(0xf8)),
        stop_ovation = @enumToInt(lu16.init(0xf9)),
        cmd_fa = @enumToInt(lu16.init(0xfa)),
        cmd_fb = @enumToInt(lu16.init(0xfb)),
        cmd_fc = @enumToInt(lu16.init(0xfc)),
        setvar_other_entry = @enumToInt(lu16.init(0xfd)),
        cmd_fe = @enumToInt(lu16.init(0xfe)),
        setvat_hiro_entry = @enumToInt(lu16.init(0xff)),
        cmd_100 = @enumToInt(lu16.init(0x100)),
        black_flash_effect = @enumToInt(lu16.init(0x101)),
        setvar_type_contest = @enumToInt(lu16.init(0x102)),
        setvar_rank_contest = @enumToInt(lu16.init(0x103)),
        cmd_104 = @enumToInt(lu16.init(0x104)),
        cmd_105 = @enumToInt(lu16.init(0x105)),
        cmd_106 = @enumToInt(lu16.init(0x106)),
        cmd_107 = @enumToInt(lu16.init(0x107)),
        store_people_id_contest = @enumToInt(lu16.init(0x108)),
        cmd_109 = @enumToInt(lu16.init(0x109)),
        setvat_hiro_entry2 = @enumToInt(lu16.init(0x10a)),
        act_people_contest = @enumToInt(lu16.init(0x10b)),
        cmd_10c = @enumToInt(lu16.init(0x10c)),
        cmd_10d = @enumToInt(lu16.init(0x10d)),
        cmd_10e = @enumToInt(lu16.init(0x10e)),
        cmd_10f = @enumToInt(lu16.init(0x10f)),
        cmd_110 = @enumToInt(lu16.init(0x110)),
        flash_contest = @enumToInt(lu16.init(0x111)),
        end_flash = @enumToInt(lu16.init(0x112)),
        carpet_anm = @enumToInt(lu16.init(0x113)),
        cmd_114 = @enumToInt(lu16.init(0x114)),
        cmd_115 = @enumToInt(lu16.init(0x115)),
        show_lnk_cnt_record = @enumToInt(lu16.init(0x116)),
        cmd_117 = @enumToInt(lu16.init(0x117)),
        cmd_118 = @enumToInt(lu16.init(0x118)),
        store_pokerus = @enumToInt(lu16.init(0x119)),
        warp_map_elevator = @enumToInt(lu16.init(0x11b)),
        check_floor = @enumToInt(lu16.init(0x11c)),
        start_lift = @enumToInt(lu16.init(0x11d)),
        store_sin_pokemon_seen = @enumToInt(lu16.init(0x11e)),
        cmd_11f = @enumToInt(lu16.init(0x11f)),
        store_tot_pokemon_seen = @enumToInt(lu16.init(0x120)),
        store_nat_pokemon_seen = @enumToInt(lu16.init(0x121)),
        set_var_text_pokedex = @enumToInt(lu16.init(0x123)),
        wild_battle = @enumToInt(lu16.init(0x124)),
        starter_battle = @enumToInt(lu16.init(0x125)),
        explanation_battle = @enumToInt(lu16.init(0x126)),
        honey_tree_battle = @enumToInt(lu16.init(0x127)),
        check_if_honey_slathered = @enumToInt(lu16.init(0x128)),
        random_battle = @enumToInt(lu16.init(0x129)),
        stop_random_battle = @enumToInt(lu16.init(0x12a)),
        write_autograph = @enumToInt(lu16.init(0x12b)),
        store_save_data = @enumToInt(lu16.init(0x12c)),
        check_save_data = @enumToInt(lu16.init(0x12d)),
        check_dress = @enumToInt(lu16.init(0x12e)),
        check_contest_win = @enumToInt(lu16.init(0x12f)),
        store_photo_name = @enumToInt(lu16.init(0x130)),
        give_poketch = @enumToInt(lu16.init(0x131)),
        check_ptch_appl = @enumToInt(lu16.init(0x132)),
        act_pktch_appl = @enumToInt(lu16.init(0x133)),
        store_poketch_app = @enumToInt(lu16.init(0x134)),
        friend_b_t = @enumToInt(lu16.init(0x135)),
        friend_b_t2 = @enumToInt(lu16.init(0x136)),
        cmd_138 = @enumToInt(lu16.init(0x138)),
        open_union_function2 = @enumToInt(lu16.init(0x139)),
        start_union = @enumToInt(lu16.init(0x13a)),
        link_closed = @enumToInt(lu16.init(0x13b)),
        set_union_function_id = @enumToInt(lu16.init(0x13c)),
        close_union_function = @enumToInt(lu16.init(0x13d)),
        close_union_function2 = @enumToInt(lu16.init(0x13e)),
        set_var_union_message = @enumToInt(lu16.init(0x13f)),
        store_your_decision_union = @enumToInt(lu16.init(0x140)),
        store_other_decision_union = @enumToInt(lu16.init(0x141)),
        cmd_142 = @enumToInt(lu16.init(0x142)),
        check_other_decision_union = @enumToInt(lu16.init(0x143)),
        store_your_decision_union2 = @enumToInt(lu16.init(0x144)),
        store_other_decision_union2 = @enumToInt(lu16.init(0x145)),
        check_other_decision_union2 = @enumToInt(lu16.init(0x146)),
        pokemart = @enumToInt(lu16.init(0x147)),
        pokemart1 = @enumToInt(lu16.init(0x148)),
        pokemart2 = @enumToInt(lu16.init(0x149)),
        pokemart3 = @enumToInt(lu16.init(0x14a)),
        defeat_go_pokecenter = @enumToInt(lu16.init(0x14b)),
        act_bike = @enumToInt(lu16.init(0x14c)),
        check_gender = @enumToInt(lu16.init(0x14d)),
        heal_pokemon = @enumToInt(lu16.init(0x14e)),
        deact_wireless = @enumToInt(lu16.init(0x14f)),
        delete_entry = @enumToInt(lu16.init(0x150)),
        cmd_151 = @enumToInt(lu16.init(0x151)),
        underground_id = @enumToInt(lu16.init(0x152)),
        union_room = @enumToInt(lu16.init(0x153)),
        open_wi_fi_sprite = @enumToInt(lu16.init(0x154)),
        store_wi_fi_sprite = @enumToInt(lu16.init(0x155)),
        act_wi_fi_sprite = @enumToInt(lu16.init(0x156)),
        cmd_157 = @enumToInt(lu16.init(0x157)),
        activate_pokedex = @enumToInt(lu16.init(0x158)),
        give_running_shoes = @enumToInt(lu16.init(0x15a)),
        check_badge = @enumToInt(lu16.init(0x15b)),
        enable_badge = @enumToInt(lu16.init(0x15c)),
        disable_badge = @enumToInt(lu16.init(0x15d)),
        check_follow = @enumToInt(lu16.init(0x160)),
        start_follow = @enumToInt(lu16.init(0x161)),
        stop_follow = @enumToInt(lu16.init(0x162)),
        cmd_164 = @enumToInt(lu16.init(0x164)),
        cmd_166 = @enumToInt(lu16.init(0x166)),
        prepare_door_animation = @enumToInt(lu16.init(0x168)),
        wait_action = @enumToInt(lu16.init(0x169)),
        wait_close = @enumToInt(lu16.init(0x16a)),
        open_door = @enumToInt(lu16.init(0x16b)),
        close_door = @enumToInt(lu16.init(0x16c)),
        act_dcare_function = @enumToInt(lu16.init(0x16d)),
        store_p_d_care_num = @enumToInt(lu16.init(0x16e)),
        pastoria_city_function = @enumToInt(lu16.init(0x16f)),
        pastoria_city_function2 = @enumToInt(lu16.init(0x170)),
        hearthrome_gym_function = @enumToInt(lu16.init(0x171)),
        hearthrome_gym_function2 = @enumToInt(lu16.init(0x172)),
        canalave_gym_function = @enumToInt(lu16.init(0x173)),
        veilstone_gym_function = @enumToInt(lu16.init(0x174)),
        sunishore_gym_function = @enumToInt(lu16.init(0x175)),
        sunishore_gym_function2 = @enumToInt(lu16.init(0x176)),
        check_party_number = @enumToInt(lu16.init(0x177)),
        open_berry_pouch = @enumToInt(lu16.init(0x178)),
        cmd_179 = @enumToInt(lu16.init(0x179)),
        cmd_17a = @enumToInt(lu16.init(0x17a)),
        cmd_17b = @enumToInt(lu16.init(0x17b)),
        set_nature_pokemon = @enumToInt(lu16.init(0x17c)),
        cmd_17d = @enumToInt(lu16.init(0x17d)),
        cmd_17e = @enumToInt(lu16.init(0x17e)),
        cmd_17f = @enumToInt(lu16.init(0x17f)),
        cmd_180 = @enumToInt(lu16.init(0x180)),
        cmd_181 = @enumToInt(lu16.init(0x181)),
        check_deoxis = @enumToInt(lu16.init(0x182)),
        cmd_183 = @enumToInt(lu16.init(0x183)),
        cmd_184 = @enumToInt(lu16.init(0x184)),
        cmd_185 = @enumToInt(lu16.init(0x185)),
        change_ow_position = @enumToInt(lu16.init(0x186)),
        set_ow_position = @enumToInt(lu16.init(0x187)),
        change_ow_movement = @enumToInt(lu16.init(0x188)),
        release_ow = @enumToInt(lu16.init(0x189)),
        set_tile_passable = @enumToInt(lu16.init(0x18a)),
        set_tile_locked = @enumToInt(lu16.init(0x18b)),
        set_ows_follow = @enumToInt(lu16.init(0x18c)),
        show_clock_save = @enumToInt(lu16.init(0x18d)),
        hide_clock_save = @enumToInt(lu16.init(0x18e)),
        cmd_18f = @enumToInt(lu16.init(0x18f)),
        set_save_data = @enumToInt(lu16.init(0x190)),
        chs_pokemenu = @enumToInt(lu16.init(0x191)),
        chs_pokemenu2 = @enumToInt(lu16.init(0x192)),
        store_poke_menu2 = @enumToInt(lu16.init(0x193)),
        chs_poke_contest = @enumToInt(lu16.init(0x194)),
        store_poke_contest = @enumToInt(lu16.init(0x195)),
        show_poke_info = @enumToInt(lu16.init(0x196)),
        store_poke_move = @enumToInt(lu16.init(0x197)),
        check_poke_egg = @enumToInt(lu16.init(0x198)),
        compare_poke_nick = @enumToInt(lu16.init(0x199)),
        check_party_number_union = @enumToInt(lu16.init(0x19a)),
        check_poke_party_health = @enumToInt(lu16.init(0x19b)),
        check_poke_party_num_d_care = @enumToInt(lu16.init(0x19c)),
        check_egg_union = @enumToInt(lu16.init(0x19d)),
        underground_function = @enumToInt(lu16.init(0x19e)),
        underground_function2 = @enumToInt(lu16.init(0x19f)),
        underground_start = @enumToInt(lu16.init(0x1a0)),
        take_money_d_care = @enumToInt(lu16.init(0x1a3)),
        take_pokemon_d_care = @enumToInt(lu16.init(0x1a4)),
        act_egg_day_c_man = @enumToInt(lu16.init(0x1a8)),
        deact_egg_day_c_man = @enumToInt(lu16.init(0x1a9)),
        set_var_poke_and_money_d_care = @enumToInt(lu16.init(0x1aa)),
        check_money_d_care = @enumToInt(lu16.init(0x1ab)),
        egg_animation = @enumToInt(lu16.init(0x1ac)),
        set_var_poke_and_level_d_care = @enumToInt(lu16.init(0x1ae)),
        set_var_poke_chosen_d_care = @enumToInt(lu16.init(0x1af)),
        give_poke_d_care = @enumToInt(lu16.init(0x1b0)),
        add_people2 = @enumToInt(lu16.init(0x1b1)),
        remove_people2 = @enumToInt(lu16.init(0x1b2)),
        mail_box = @enumToInt(lu16.init(0x1b3)),
        check_mail = @enumToInt(lu16.init(0x1b4)),
        show_record_list = @enumToInt(lu16.init(0x1b5)),
        check_time = @enumToInt(lu16.init(0x1b6)),
        check_id_player = @enumToInt(lu16.init(0x1b7)),
        random_text_stored = @enumToInt(lu16.init(0x1b8)),
        store_happy_poke = @enumToInt(lu16.init(0x1b9)),
        store_happy_status = @enumToInt(lu16.init(0x1ba)),
        set_var_data_day_care = @enumToInt(lu16.init(0x1bc)),
        check_face_position = @enumToInt(lu16.init(0x1bd)),
        store_poke_d_care_love = @enumToInt(lu16.init(0x1be)),
        check_status_solaceon_event = @enumToInt(lu16.init(0x1bf)),
        check_poke_party = @enumToInt(lu16.init(0x1c0)),
        copy_pokemon_height = @enumToInt(lu16.init(0x1c1)),
        set_variable_pokemon_height = @enumToInt(lu16.init(0x1c2)),
        compare_pokemon_height = @enumToInt(lu16.init(0x1c3)),
        check_pokemon_height = @enumToInt(lu16.init(0x1c4)),
        show_move_info = @enumToInt(lu16.init(0x1c5)),
        store_poke_delete = @enumToInt(lu16.init(0x1c6)),
        store_move_delete = @enumToInt(lu16.init(0x1c7)),
        check_move_num_delete = @enumToInt(lu16.init(0x1c8)),
        store_delete_move = @enumToInt(lu16.init(0x1c9)),
        check_delete_move = @enumToInt(lu16.init(0x1ca)),
        setvar_move_delete = @enumToInt(lu16.init(0x1cb)),
        cmd_1cc = @enumToInt(lu16.init(0x1cc)),
        de_activate_leader = @enumToInt(lu16.init(0x1cd)),
        hm_functions = @enumToInt(lu16.init(0x1cf)),
        flash_duration = @enumToInt(lu16.init(0x1d0)),
        defog_duration = @enumToInt(lu16.init(0x1d1)),
        give_accessories = @enumToInt(lu16.init(0x1d2)),
        check_accessories = @enumToInt(lu16.init(0x1d3)),
        cmd_1d4 = @enumToInt(lu16.init(0x1d4)),
        give_accessories2 = @enumToInt(lu16.init(0x1d5)),
        check_accessories2 = @enumToInt(lu16.init(0x1d6)),
        berry_poffin = @enumToInt(lu16.init(0x1d7)),
        set_var_b_tower_chs = @enumToInt(lu16.init(0x1d8)),
        battle_room_result = @enumToInt(lu16.init(0x1d9)),
        activate_b_tower = @enumToInt(lu16.init(0x1da)),
        store_b_tower_data = @enumToInt(lu16.init(0x1db)),
        close_b_tower = @enumToInt(lu16.init(0x1dc)),
        call_b_tower_functions = @enumToInt(lu16.init(0x1dd)),
        random_team_b_tower = @enumToInt(lu16.init(0x1de)),
        store_prize_num_b_tower = @enumToInt(lu16.init(0x1df)),
        store_people_id_b_tower = @enumToInt(lu16.init(0x1e0)),
        call_b_tower_wire_function = @enumToInt(lu16.init(0x1e1)),
        store_p_chosen_wire_b_tower = @enumToInt(lu16.init(0x1e2)),
        store_rank_data_wire_b_tower = @enumToInt(lu16.init(0x1e3)),
        cmd_1e4 = @enumToInt(lu16.init(0x1e4)),
        random_event = @enumToInt(lu16.init(0x1e5)),
        check_sinnoh_pokedex = @enumToInt(lu16.init(0x1e8)),
        check_national_pokedex = @enumToInt(lu16.init(0x1e9)),
        show_sinnoh_sheet = @enumToInt(lu16.init(0x1ea)),
        show_national_sheet = @enumToInt(lu16.init(0x1eb)),
        cmd_1ec = @enumToInt(lu16.init(0x1ec)),
        store_trophy_pokemon = @enumToInt(lu16.init(0x1ed)),
        cmd_1ef = @enumToInt(lu16.init(0x1ef)),
        cmd_1f0 = @enumToInt(lu16.init(0x1f0)),
        check_act_fossil = @enumToInt(lu16.init(0x1f1)),
        cmd_1f2 = @enumToInt(lu16.init(0x1f2)),
        cmd_1f3 = @enumToInt(lu16.init(0x1f3)),
        check_item_chosen = @enumToInt(lu16.init(0x1f4)),
        compare_item_poke_fossil = @enumToInt(lu16.init(0x1f5)),
        check_pokemon_level = @enumToInt(lu16.init(0x1f6)),
        check_is_pokemon_poisoned = @enumToInt(lu16.init(0x1f7)),
        pre_wfc = @enumToInt(lu16.init(0x1f8)),
        store_furniture = @enumToInt(lu16.init(0x1f9)),
        copy_furniture = @enumToInt(lu16.init(0x1fb)),
        set_b_castle_function_id = @enumToInt(lu16.init(0x1fe)),
        b_castle_funct_return = @enumToInt(lu16.init(0x1ff)),
        cmd_200 = @enumToInt(lu16.init(0x200)),
        check_effect_hm = @enumToInt(lu16.init(0x201)),
        great_marsh_function = @enumToInt(lu16.init(0x202)),
        battle_poke_colosseum = @enumToInt(lu16.init(0x203)),
        warp_last_elevator = @enumToInt(lu16.init(0x204)),
        open_geo_net = @enumToInt(lu16.init(0x205)),
        great_marsh_bynocule = @enumToInt(lu16.init(0x206)),
        store_poke_colosseum_lost = @enumToInt(lu16.init(0x207)),
        pokemon_picture = @enumToInt(lu16.init(0x208)),
        hide_picture = @enumToInt(lu16.init(0x209)),
        cmd_20a = @enumToInt(lu16.init(0x20a)),
        cmd_20b = @enumToInt(lu16.init(0x20b)),
        cmd_20c = @enumToInt(lu16.init(0x20c)),
        setvar_mt_coronet = @enumToInt(lu16.init(0x20d)),
        cmd_20e = @enumToInt(lu16.init(0x20e)),
        check_quic_trine_coordinates = @enumToInt(lu16.init(0x20f)),
        setvar_quick_train_coordinates = @enumToInt(lu16.init(0x210)),
        move_train_anm = @enumToInt(lu16.init(0x211)),
        store_poke_nature = @enumToInt(lu16.init(0x212)),
        check_poke_nature = @enumToInt(lu16.init(0x213)),
        random_hallowes = @enumToInt(lu16.init(0x214)),
        start_amity = @enumToInt(lu16.init(0x215)),
        cmd_216 = @enumToInt(lu16.init(0x216)),
        cmd_217 = @enumToInt(lu16.init(0x217)),
        chs_r_s_poke = @enumToInt(lu16.init(0x218)),
        set_s_poke = @enumToInt(lu16.init(0x219)),
        check_s_poke = @enumToInt(lu16.init(0x21a)),
        cmd_21b = @enumToInt(lu16.init(0x21b)),
        act_swarm_poke = @enumToInt(lu16.init(0x21c)),
        cmd_21d = @enumToInt(lu16.init(0x21d)),
        cmd_21e = @enumToInt(lu16.init(0x21e)),
        check_move_remember = @enumToInt(lu16.init(0x21f)),
        cmd_220 = @enumToInt(lu16.init(0x220)),
        store_poke_remember = @enumToInt(lu16.init(0x221)),
        cmd_222 = @enumToInt(lu16.init(0x222)),
        store_remember_move = @enumToInt(lu16.init(0x223)),
        teach_move = @enumToInt(lu16.init(0x224)),
        check_teach_move = @enumToInt(lu16.init(0x225)),
        set_trade_id = @enumToInt(lu16.init(0x226)),
        check_pokemon_trade = @enumToInt(lu16.init(0x228)),
        trade_chosen_pokemon = @enumToInt(lu16.init(0x229)),
        stop_trade = @enumToInt(lu16.init(0x22a)),
        cmd_22b = @enumToInt(lu16.init(0x22b)),
        close_oak_assistant_event = @enumToInt(lu16.init(0x22c)),
        check_nat_pokedex_status = @enumToInt(lu16.init(0x22d)),
        check_ribbon_number = @enumToInt(lu16.init(0x22f)),
        check_ribbon = @enumToInt(lu16.init(0x230)),
        give_ribbon = @enumToInt(lu16.init(0x231)),
        setvar_ribbon = @enumToInt(lu16.init(0x232)),
        check_happy_ribbon = @enumToInt(lu16.init(0x233)),
        check_pokemart = @enumToInt(lu16.init(0x234)),
        check_furniture = @enumToInt(lu16.init(0x235)),
        cmd_236 = @enumToInt(lu16.init(0x236)),
        check_phrase_box_input = @enumToInt(lu16.init(0x237)),
        check_status_phrase_box = @enumToInt(lu16.init(0x238)),
        decide_rules = @enumToInt(lu16.init(0x239)),
        check_foot_step = @enumToInt(lu16.init(0x23a)),
        heal_pokemon_animation = @enumToInt(lu16.init(0x23b)),
        store_elevator_direction = @enumToInt(lu16.init(0x23c)),
        ship_animation = @enumToInt(lu16.init(0x23d)),
        cmd_23e = @enumToInt(lu16.init(0x23e)),
        store_phrase_box1_w = @enumToInt(lu16.init(0x243)),
        store_phrase_box2_w = @enumToInt(lu16.init(0x244)),
        setvar_phrase_box1_w = @enumToInt(lu16.init(0x245)),
        store_mt_coronet = @enumToInt(lu16.init(0x246)),
        check_first_poke_party = @enumToInt(lu16.init(0x247)),
        check_poke_type = @enumToInt(lu16.init(0x248)),
        check_phrase_box_input2 = @enumToInt(lu16.init(0x249)),
        store_und_time = @enumToInt(lu16.init(0x24a)),
        prepare_pc_animation = @enumToInt(lu16.init(0x24b)),
        open_pc_animation = @enumToInt(lu16.init(0x24c)),
        close_pc_animation = @enumToInt(lu16.init(0x24d)),
        check_lotto_number = @enumToInt(lu16.init(0x24e)),
        compare_lotto_number = @enumToInt(lu16.init(0x24f)),
        setvar_id_poke_boxes = @enumToInt(lu16.init(0x251)),
        cmd_250 = @enumToInt(lu16.init(0x250)),
        check_boxes_number = @enumToInt(lu16.init(0x252)),
        stop_great_marsh = @enumToInt(lu16.init(0x253)),
        check_poke_catching_show = @enumToInt(lu16.init(0x254)),
        close_catching_show = @enumToInt(lu16.init(0x255)),
        check_catching_show_records = @enumToInt(lu16.init(0x256)),
        sprt_save = @enumToInt(lu16.init(0x257)),
        ret_sprt_save = @enumToInt(lu16.init(0x258)),
        elev_lg_animation = @enumToInt(lu16.init(0x259)),
        check_elev_lg_anm = @enumToInt(lu16.init(0x25a)),
        elev_ir_anm = @enumToInt(lu16.init(0x25b)),
        stop_elev_anm = @enumToInt(lu16.init(0x25c)),
        check_elev_position = @enumToInt(lu16.init(0x25d)),
        galact_anm = @enumToInt(lu16.init(0x25e)),
        galact_anm2 = @enumToInt(lu16.init(0x25f)),
        main_event = @enumToInt(lu16.init(0x260)),
        check_accessories3 = @enumToInt(lu16.init(0x261)),
        act_deoxis_form_change = @enumToInt(lu16.init(0x262)),
        change_form_deoxis = @enumToInt(lu16.init(0x263)),
        check_coombe_event = @enumToInt(lu16.init(0x264)),
        act_contest_map = @enumToInt(lu16.init(0x265)),
        cmd_266 = @enumToInt(lu16.init(0x266)),
        pokecasino = @enumToInt(lu16.init(0x267)),
        check_time2 = @enumToInt(lu16.init(0x268)),
        regigigas_anm = @enumToInt(lu16.init(0x269)),
        cresselia_anm = @enumToInt(lu16.init(0x26a)),
        check_regi = @enumToInt(lu16.init(0x26b)),
        check_massage = @enumToInt(lu16.init(0x26c)),
        unown_message_box = @enumToInt(lu16.init(0x26d)),
        check_p_catching_show = @enumToInt(lu16.init(0x26e)),
        cmd_26f = @enumToInt(lu16.init(0x26f)),
        shaymin_anm = @enumToInt(lu16.init(0x270)),
        thank_name_insert = @enumToInt(lu16.init(0x271)),
        setvar_shaymin = @enumToInt(lu16.init(0x272)),
        setvar_accessories2 = @enumToInt(lu16.init(0x273)),
        cmd_274 = @enumToInt(lu16.init(0x274)),
        check_record_casino = @enumToInt(lu16.init(0x275)),
        check_coins_casino = @enumToInt(lu16.init(0x276)),
        srt_random_num = @enumToInt(lu16.init(0x277)),
        check_poke_level2 = @enumToInt(lu16.init(0x278)),
        cmd_279 = @enumToInt(lu16.init(0x279)),
        league_castle_view = @enumToInt(lu16.init(0x27a)),
        cmd_27b = @enumToInt(lu16.init(0x27b)),
        setvar_amity_pokemon = @enumToInt(lu16.init(0x27c)),
        cmd_27d = @enumToInt(lu16.init(0x27d)),
        check_first_time_v_shop = @enumToInt(lu16.init(0x27e)),
        cmd_27f = @enumToInt(lu16.init(0x27f)),
        setvar_id_number = @enumToInt(lu16.init(0x280)),
        cmd_281 = @enumToInt(lu16.init(0x281)),
        setvar_unk = @enumToInt(lu16.init(0x282)),
        cmd_283 = @enumToInt(lu16.init(0x283)),
        check_ruin_maniac = @enumToInt(lu16.init(0x284)),
        check_turn_back = @enumToInt(lu16.init(0x285)),
        check_ug_people_num = @enumToInt(lu16.init(0x286)),
        check_ug_fossil_num = @enumToInt(lu16.init(0x287)),
        check_ug_traps_num = @enumToInt(lu16.init(0x288)),
        check_poffin_item = @enumToInt(lu16.init(0x289)),
        check_poffin_case_status = @enumToInt(lu16.init(0x28a)),
        unk_funct2 = @enumToInt(lu16.init(0x28b)),
        pokemon_party_picture = @enumToInt(lu16.init(0x28c)),
        act_learning = @enumToInt(lu16.init(0x28d)),
        set_sound_learning = @enumToInt(lu16.init(0x28e)),
        check_first_time_champion = @enumToInt(lu16.init(0x28f)),
        choose_poke_d_care = @enumToInt(lu16.init(0x290)),
        store_poke_d_care = @enumToInt(lu16.init(0x291)),
        cmd_292 = @enumToInt(lu16.init(0x292)),
        check_master_rank = @enumToInt(lu16.init(0x293)),
        show_battle_points_box = @enumToInt(lu16.init(0x294)),
        hide_battle_points_box = @enumToInt(lu16.init(0x295)),
        update_battle_points_box = @enumToInt(lu16.init(0x296)),
        take_b_points = @enumToInt(lu16.init(0x299)),
        check_b_points = @enumToInt(lu16.init(0x29a)),
        cmd_29c = @enumToInt(lu16.init(0x29c)),
        choice_multi = @enumToInt(lu16.init(0x29d)),
        h_m_effect = @enumToInt(lu16.init(0x29e)),
        camera_bump_effect = @enumToInt(lu16.init(0x29f)),
        double_battle = @enumToInt(lu16.init(0x2a0)),
        apply_movement2 = @enumToInt(lu16.init(0x2a1)),
        cmd_2a2 = @enumToInt(lu16.init(0x2a2)),
        store_act_hero_friend_code = @enumToInt(lu16.init(0x2a3)),
        store_act_other_friend_code = @enumToInt(lu16.init(0x2a4)),
        choose_trade_pokemon = @enumToInt(lu16.init(0x2a5)),
        chs_prize_casino = @enumToInt(lu16.init(0x2a6)),
        check_plate = @enumToInt(lu16.init(0x2a7)),
        take_coins_casino = @enumToInt(lu16.init(0x2a8)),
        check_coins_casino2 = @enumToInt(lu16.init(0x2a9)),
        compare_phrase_box_input = @enumToInt(lu16.init(0x2aa)),
        store_seal_num = @enumToInt(lu16.init(0x2ab)),
        activate_mystery_gift = @enumToInt(lu16.init(0x2ac)),
        check_follow_battle = @enumToInt(lu16.init(0x2ad)),
        cmd_2af = @enumToInt(lu16.init(0x2af)),
        cmd_2b0 = @enumToInt(lu16.init(0x2b0)),
        cmd_2b1 = @enumToInt(lu16.init(0x2b1)),
        cmd_2b2 = @enumToInt(lu16.init(0x2b2)),
        setvar_seal_random = @enumToInt(lu16.init(0x2b3)),
        darkrai_function = @enumToInt(lu16.init(0x2b5)),
        cmd_2b6 = @enumToInt(lu16.init(0x2b6)),
        store_poke_num_party = @enumToInt(lu16.init(0x2b7)),
        store_poke_nickname = @enumToInt(lu16.init(0x2b8)),
        close_multi_union = @enumToInt(lu16.init(0x2b9)),
        check_battle_union = @enumToInt(lu16.init(0x2ba)),
        cmd_2_b_b = @enumToInt(lu16.init(0x2bb)),
        check_wild_battle2 = @enumToInt(lu16.init(0x2bc)),
        wild_battle2 = @enumToInt(lu16.init(0x2bd)),
        store_trainer_card_star = @enumToInt(lu16.init(0x2be)),
        bike_ride = @enumToInt(lu16.init(0x2bf)),
        cmd_2c0 = @enumToInt(lu16.init(0x2c0)),
        show_save_box = @enumToInt(lu16.init(0x2c1)),
        hide_save_box = @enumToInt(lu16.init(0x2c2)),
        cmd_2c3 = @enumToInt(lu16.init(0x2c3)),
        show_b_tower_some = @enumToInt(lu16.init(0x2c4)),
        delete_saves_b_factory = @enumToInt(lu16.init(0x2c5)),
        spin_trade_union = @enumToInt(lu16.init(0x2c6)),
        check_version_game = @enumToInt(lu16.init(0x2c7)),
        show_b_arcade_recors = @enumToInt(lu16.init(0x2c8)),
        eterna_gym_anm = @enumToInt(lu16.init(0x2c9)),
        floral_clock_animation = @enumToInt(lu16.init(0x2ca)),
        check_poke_party2 = @enumToInt(lu16.init(0x2cb)),
        check_poke_castle = @enumToInt(lu16.init(0x2cc)),
        act_team_galactic_events = @enumToInt(lu16.init(0x2cd)),
        choose_wire_poke_b_castle = @enumToInt(lu16.init(0x2cf)),
        cmd_2d0 = @enumToInt(lu16.init(0x2d0)),
        cmd_2d1 = @enumToInt(lu16.init(0x2d1)),
        cmd_2d2 = @enumToInt(lu16.init(0x2d2)),
        cmd_2d3 = @enumToInt(lu16.init(0x2d3)),
        cmd_2d4 = @enumToInt(lu16.init(0x2d4)),
        cmd_2d5 = @enumToInt(lu16.init(0x2d5)),
        cmd_2d6 = @enumToInt(lu16.init(0x2d6)),
        cmd_2d7 = @enumToInt(lu16.init(0x2d7)),
        cmd_2d8 = @enumToInt(lu16.init(0x2d8)),
        cmd_2d9 = @enumToInt(lu16.init(0x2d9)),
        cmd_2da = @enumToInt(lu16.init(0x2da)),
        cmd_2db = @enumToInt(lu16.init(0x2db)),
        cmd_2dc = @enumToInt(lu16.init(0x2dc)),
        cmd_2dd = @enumToInt(lu16.init(0x2dd)),
        cmd_2de = @enumToInt(lu16.init(0x2de)),
        cmd_2df = @enumToInt(lu16.init(0x2df)),
        cmd_2e0 = @enumToInt(lu16.init(0x2e0)),
        cmd_2e1 = @enumToInt(lu16.init(0x2e1)),
        cmd_2e2 = @enumToInt(lu16.init(0x2e2)),
        cmd_2e3 = @enumToInt(lu16.init(0x2e3)),
        cmd_2e4 = @enumToInt(lu16.init(0x2e4)),
        cmd_2e5 = @enumToInt(lu16.init(0x2e5)),
        cmd_2e6 = @enumToInt(lu16.init(0x2e6)),
        cmd_2e7 = @enumToInt(lu16.init(0x2e7)),
        cmd_2e8 = @enumToInt(lu16.init(0x2e8)),
        cmd_2e9 = @enumToInt(lu16.init(0x2e9)),
        cmd_2ea = @enumToInt(lu16.init(0x2ea)),
        cmd_2eb = @enumToInt(lu16.init(0x2eb)),
        cmd_2ec = @enumToInt(lu16.init(0x2ec)),
        cmd_2ed = @enumToInt(lu16.init(0x2ed)),
        cmd_2ee = @enumToInt(lu16.init(0x2ee)),
        cmd_2f0 = @enumToInt(lu16.init(0x2f0)),
        cmd_2f2 = @enumToInt(lu16.init(0x2f2)),
        cmd_2f3 = @enumToInt(lu16.init(0x2f3)),
        cmd_2f4 = @enumToInt(lu16.init(0x2f4)),
        cmd_2f5 = @enumToInt(lu16.init(0x2f5)),
        cmd_2f6 = @enumToInt(lu16.init(0x2f6)),
        cmd_2f7 = @enumToInt(lu16.init(0x2f7)),
        cmd_2f8 = @enumToInt(lu16.init(0x2f8)),
        cmd_2f9 = @enumToInt(lu16.init(0x2f9)),
        cmd_2fa = @enumToInt(lu16.init(0x2fa)),
        cmd_2fb = @enumToInt(lu16.init(0x2fb)),
        cmd_2fc = @enumToInt(lu16.init(0x2fc)),
        cmd_2fd = @enumToInt(lu16.init(0x2fd)),
        cmd_2fe = @enumToInt(lu16.init(0x2fe)),
        cmd_2ff = @enumToInt(lu16.init(0x2ff)),
        cmd_300 = @enumToInt(lu16.init(0x300)),
        cmd_302 = @enumToInt(lu16.init(0x302)),
        cmd_303 = @enumToInt(lu16.init(0x303)),
        cmd_304 = @enumToInt(lu16.init(0x304)),
        cmd_305 = @enumToInt(lu16.init(0x305)),
        cmd_306 = @enumToInt(lu16.init(0x306)),
        cmd_307 = @enumToInt(lu16.init(0x307)),
        cmd_308 = @enumToInt(lu16.init(0x308)),
        cmd_309 = @enumToInt(lu16.init(0x309)),
        cmd_30a = @enumToInt(lu16.init(0x30a)),
        cmd_30b = @enumToInt(lu16.init(0x30b)),
        cmd_30c = @enumToInt(lu16.init(0x30c)),
        cmd_30d = @enumToInt(lu16.init(0x30d)),
        cmd_30e = @enumToInt(lu16.init(0x30e)),
        cmd_30f = @enumToInt(lu16.init(0x30f)),
        cmd_310 = @enumToInt(lu16.init(0x310)),
        cmd_311 = @enumToInt(lu16.init(0x311)),
        cmd_312 = @enumToInt(lu16.init(0x312)),
        cmd_313 = @enumToInt(lu16.init(0x313)),
        cmd_314 = @enumToInt(lu16.init(0x314)),
        cmd_315 = @enumToInt(lu16.init(0x315)),
        cmd_316 = @enumToInt(lu16.init(0x316)),
        cmd_317 = @enumToInt(lu16.init(0x317)),
        wild_battle3 = @enumToInt(lu16.init(0x318)),
        cmd_319 = @enumToInt(lu16.init(0x319)),
        cmd_31a = @enumToInt(lu16.init(0x31a)),
        cmd_31b = @enumToInt(lu16.init(0x31b)),
        cmd_31c = @enumToInt(lu16.init(0x31c)),
        cmd_31d = @enumToInt(lu16.init(0x31d)),
        cmd_31e = @enumToInt(lu16.init(0x31e)),
        cmd_31f = @enumToInt(lu16.init(0x31f)),
        cmd_320 = @enumToInt(lu16.init(0x320)),
        cmd_321 = @enumToInt(lu16.init(0x321)),
        cmd_322 = @enumToInt(lu16.init(0x322)),
        cmd_323 = @enumToInt(lu16.init(0x323)),
        cmd_324 = @enumToInt(lu16.init(0x324)),
        cmd_325 = @enumToInt(lu16.init(0x325)),
        cmd_326 = @enumToInt(lu16.init(0x326)),
        cmd_327 = @enumToInt(lu16.init(0x327)),
        portal_effect = @enumToInt(lu16.init(0x328)),
        cmd_329 = @enumToInt(lu16.init(0x329)),
        cmd_32a = @enumToInt(lu16.init(0x32a)),
        cmd_32b = @enumToInt(lu16.init(0x32b)),
        cmd_32c = @enumToInt(lu16.init(0x32c)),
        cmd_32d = @enumToInt(lu16.init(0x32d)),
        cmd_32e = @enumToInt(lu16.init(0x32e)),
        cmd_32f = @enumToInt(lu16.init(0x32f)),
        cmd_330 = @enumToInt(lu16.init(0x330)),
        cmd_331 = @enumToInt(lu16.init(0x331)),
        cmd_332 = @enumToInt(lu16.init(0x332)),
        cmd_333 = @enumToInt(lu16.init(0x333)),
        cmd_334 = @enumToInt(lu16.init(0x334)),
        cmd_335 = @enumToInt(lu16.init(0x335)),
        cmd_336 = @enumToInt(lu16.init(0x336)),
        cmd_337 = @enumToInt(lu16.init(0x337)),
        cmd_338 = @enumToInt(lu16.init(0x338)),
        cmd_339 = @enumToInt(lu16.init(0x339)),
        cmd_33a = @enumToInt(lu16.init(0x33a)),
        cmd_33c = @enumToInt(lu16.init(0x33c)),
        cmd_33d = @enumToInt(lu16.init(0x33d)),
        cmd_33e = @enumToInt(lu16.init(0x33e)),
        cmd_33f = @enumToInt(lu16.init(0x33f)),
        cmd_340 = @enumToInt(lu16.init(0x340)),
        cmd_341 = @enumToInt(lu16.init(0x341)),
        cmd_342 = @enumToInt(lu16.init(0x342)),
        cmd_343 = @enumToInt(lu16.init(0x343)),
        cmd_344 = @enumToInt(lu16.init(0x344)),
        cmd_345 = @enumToInt(lu16.init(0x345)),
        cmd_346 = @enumToInt(lu16.init(0x346)),
        display_floor = @enumToInt(lu16.init(0x347)),
    };
    ...
    pub const Cmd_21d = extern struct {
        ...
        pub const Kind2 = enum(u16) {
            @"0" = @enumToInt(lu16.init(0)),
            @"1" = @enumToInt(lu16.init(1)),
            @"2" = @enumToInt(lu16.init(2)),
            @"3" = @enumToInt(lu16.init(3)),
            @"4" = @enumToInt(lu16.init(4)),
            @"5" = @enumToInt(lu16.init(5)),
        };
    };
