...
pub const Command = extern union {
    ...
    pub const Kind = enum(u16) {
        ...
        call = 0x1a,
        @"return" = 0x1b,
        compare_last_result_jump = 0x1c,
        compare_last_result_call = 0x1d,
        set_flag = 0x1e,
        clear_flag = 0x1f,
        check_flag = 0x20,
        cmd_21 = 0x21,
        ...
        set_trainer_id = 0x23,
        cmd_24 = 0x24,
        clear_trainer_id = 0x25,
        script_cmd__add_value = 0x26,
        script_cmd__sub_value = 0x27,
        set_var = 0x28,
        copy_var = 0x29,
        message2 = 0x2b,
        message = 0x2c,
        ...
        cmd_32 = 0x32,
        cmd_33 = 0x33,
        close_msg_on_key_press = 0x34,
        freeze_message_box = 0x35,
        call_message_box = 0x36,
        color_msg_box = 0x37,
        type_message_box = 0x38,
        no_map_message_box = 0x39,
        call_text_msg_box = 0x3a,
        store_menu_status = 0x3b,
        show_menu = 0x3c,
        yes_no_box = 0x3e,
        multi = 0x40,
        multi2 = 0x41,
        ...
        cmd_53 = 0x53,
        switch_music = 0x54,
        store_saying_learned = 0x55,
        play_sound2 = 0x57,
        cmd_58 = 0x58,
        check_saying_learned = 0x59,
        swith_music2 = 0x5a,
        act_microphone = 0x5b,
        deact_microphone = 0x5c,
        cmd_5d = 0x5d,
        apply_movement = 0x5e,
        wait_movement = 0x5f,
        lock_all = 0x60,
        ...
        zoom_cam = 0x67,
        face_player = 0x68,
        check_sprite_position = 0x69,
        check_person_position = 0x6b,
        continue_follow = 0x6c,
        follow_hero = 0x6d,
        take_money = 0x70,
        check_money = 0x71,
        show_money = 0x72,
        ...
        take_item = 0x7b,
        give_item = 0x7c,
        check_store_item = 0x7d,
        check_item = 0x7e,
        store_item_taken = 0x7f,
        store_item_type = 0x80,
        send_item_type1 = 0x83,
        cmd_84 = 0x84,
        check_underground_pc_status = 0x85,
        cmd_86 = 0x86,
        send_item_type2 = 0x87,
        cmd_88 = 0x88,
        cmd_89 = 0x89,
        cmd_8a = 0x8a,
        cmd_8b = 0x8b,
        ...
        cmd_8d = 0x8d,
        cmd_8e = 0x8e,
        send_item_type3 = 0x8f,
        check_pokemon_party = 0x93,
        store_pokemon_party = 0x94,
        set_pokemon_party_stored = 0x95,
        give_pokemon = 0x96,
        give_egg = 0x97,
        check_move = 0x99,
        check_place_stored = 0x9a,
        cmd_9b = 0x9b,
        cmd_9c = 0x9c,
        cmd_9d = 0x9d,
        cmd_9e = 0x9e,
        ...
        interview = 0xa5,
        dress_pokemon = 0xa6,
        display_dressed_pokemon = 0xa7,
        display_contest_pokemon = 0xa8,
        open_ball_capsule = 0xa9,
        open_sinnoh_maps = 0xaa,
        open_pc_function = 0xab,
        draw_union = 0xac,
        trainer_case_union = 0xad,
        trade_union = 0xae,
        record_mixing_union = 0xaf,
        end_game = 0xb0,
        hall_fame_anm = 0xb1,
        store_wfc_status = 0xb2,
        start_wfc = 0xb3,
        choose_starter = 0xb4,
        battle_starter = 0xb5,
        battle_id = 0xb6,
        set_var_battle = 0xb7,
        check_battle_type = 0xb8,
        set_var_battle2 = 0xb9,
        choose_poke_nick = 0xbb,
        fade_screen = 0xbc,
        reset_screen = 0xbd,
        warp = 0xbe,
        rock_climb_animation = 0xbf,
        surf_animation = 0xc0,
        waterfall_animation = 0xc1,
        flash_animation = 0xc3,
        defog_animation = 0xc4,
        prep_hm_effect = 0xc5,
        tuxedo = 0xc6,
        check_bike = 0xc7,
        ride_bike = 0xc8,
        ride_bike2 = 0xc9,
        give_poke_hiro_anm = 0xcb,
        stop_give_poke_hiro_anm = 0xcc,
        set_var_hero = 0xcd,
        set_variable_rival = 0xce,
        set_var_alter = 0xcf,
        set_var_poke = 0xd0,
        set_var_item = 0xd1,
        set_var_item_num = 0xd2,
        set_var_atk_item = 0xd3,
        set_var_atk = 0xd4,
        set_variable_number = 0xd5,
        set_var_poke_nick = 0xd6,
        set_var_obj = 0xd7,
        set_var_trainer = 0xd8,
        set_var_wi_fi_sprite = 0xd9,
        set_var_poke_stored = 0xda,
        set_var_str_hero = 0xdb,
        set_var_str_rival = 0xdc,
        store_starter = 0xde,
        cmd_df = 0xdf,
        set_var_item_stored = 0xe0,
        set_var_item_stored2 = 0xe1,
        set_var_swarm_poke = 0xe2,
        check_swarm_poke = 0xe3,
        start_battle_analysis = 0xe4,
        trainer_battle = 0xe5,
        endtrainer_battle = 0xe6,
        trainer_battle_stored = 0xe7,
        trainer_battle_stored2 = 0xe8,
        check_trainer_status = 0xe9,
        store_league_trainer = 0xea,
        lost_go_pc = 0xeb,
        check_trainer_lost = 0xec,
        check_trainer_status2 = 0xed,
        store_poke_party_defeated = 0xee,
        chs_friend = 0xf2,
        wire_battle_wait = 0xf3,
        cmd_f6 = 0xf6,
        pokecontest = 0xf7,
        start_ovation = 0xf8,
        stop_ovation = 0xf9,
        ...
        cmd_fb = 0xfb,
        cmd_fc = 0xfc,
        setvar_other_entry = 0xfd,
        cmd_fe = 0xfe,
        setvat_hiro_entry = 0xff,
        cmd_100 = 0x100,
        black_flash_effect = 0x101,
        setvar_type_contest = 0x102,
        setvar_rank_contest = 0x103,
        cmd_104 = 0x104,
        cmd_105 = 0x105,
        cmd_106 = 0x106,
        cmd_107 = 0x107,
        store_people_id_contest = 0x108,
        cmd_109 = 0x109,
        setvat_hiro_entry2 = 0x10a,
        act_people_contest = 0x10b,
        cmd_10c = 0x10c,
        cmd_10d = 0x10d,
        cmd_10e = 0x10e,
        cmd_10f = 0x10f,
        ...
        cmd_114 = 0x114,
        cmd_115 = 0x115,
        show_lnk_cnt_record = 0x116,
        cmd_117 = 0x117,
        cmd_118 = 0x118,
        store_pokerus = 0x119,
        warp_map_elevator = 0x11b,
        check_floor = 0x11c,
        start_lift = 0x11d,
        store_sin_pokemon_seen = 0x11e,
        cmd_11f = 0x11f,
        store_tot_pokemon_seen = 0x120,
        store_nat_pokemon_seen = 0x121,
        set_var_text_pokedex = 0x123,
        wild_battle = 0x124,
        starter_battle = 0x125,
        explanation_battle = 0x126,
        honey_tree_battle = 0x127,
        check_if_honey_slathered = 0x128,
        random_battle = 0x129,
        stop_random_battle = 0x12a,
        write_autograph = 0x12b,
        store_save_data = 0x12c,
        check_save_data = 0x12d,
        check_dress = 0x12e,
        check_contest_win = 0x12f,
        store_photo_name = 0x130,
        give_poketch = 0x131,
        check_ptch_appl = 0x132,
        act_pktch_appl = 0x133,
        store_poketch_app = 0x134,
        friend_b_t = 0x135,
        friend_b_t2 = 0x136,
        cmd_138 = 0x138,
        open_union_function2 = 0x139,
        start_union = 0x13a,
        link_closed = 0x13b,
        set_union_function_id = 0x13c,
        close_union_function = 0x13d,
        close_union_function2 = 0x13e,
        set_var_union_message = 0x13f,
        store_your_decision_union = 0x140,
        store_other_decision_union = 0x141,
        cmd_142 = 0x142,
        check_other_decision_union = 0x143,
        store_your_decision_union2 = 0x144,
        store_other_decision_union2 = 0x145,
        check_other_decision_union2 = 0x146,
        pokemart = 0x147,
        pokemart1 = 0x148,
        pokemart2 = 0x149,
        pokemart3 = 0x14a,
        defeat_go_pokecenter = 0x14b,
        act_bike = 0x14c,
        check_gender = 0x14d,
        heal_pokemon = 0x14e,
        deact_wireless = 0x14f,
        delete_entry = 0x150,
        cmd_151 = 0x151,
        underground_id = 0x152,
        union_room = 0x153,
        open_wi_fi_sprite = 0x154,
        store_wi_fi_sprite = 0x155,
        act_wi_fi_sprite = 0x156,
        cmd_157 = 0x157,
        activate_pokedex = 0x158,
        give_running_shoes = 0x15a,
        check_badge = 0x15b,
        enable_badge = 0x15c,
        disable_badge = 0x15d,
        check_follow = 0x160,
        ...
        cmd_164 = 0x164,
        cmd_166 = 0x166,
        prepare_door_animation = 0x168,
        wait_action = 0x169,
        wait_close = 0x16a,
        open_door = 0x16b,
        close_door = 0x16c,
        act_dcare_function = 0x16d,
        store_p_d_care_num = 0x16e,
        pastoria_city_function = 0x16f,
        pastoria_city_function2 = 0x170,
        hearthrome_gym_function = 0x171,
        hearthrome_gym_function2 = 0x172,
        canalave_gym_function = 0x173,
        veilstone_gym_function = 0x174,
        sunishore_gym_function = 0x175,
        sunishore_gym_function2 = 0x176,
        check_party_number = 0x177,
        open_berry_pouch = 0x178,
        cmd_179 = 0x179,
        cmd_17a = 0x17a,
        cmd_17b = 0x17b,
        set_nature_pokemon = 0x17c,
        cmd_17d = 0x17d,
        cmd_17e = 0x17e,
        cmd_17f = 0x17f,
        cmd_180 = 0x180,
        ...
        cmd_184 = 0x184,
        cmd_185 = 0x185,
        change_ow_position = 0x186,
        set_ow_position = 0x187,
        change_ow_movement = 0x188,
        release_ow = 0x189,
        set_tile_passable = 0x18a,
        set_tile_locked = 0x18b,
        set_ows_follow = 0x18c,
        show_clock_save = 0x18d,
        hide_clock_save = 0x18e,
        cmd_18f = 0x18f,
        set_save_data = 0x190,
        chs_pokemenu = 0x191,
        chs_pokemenu2 = 0x192,
        store_poke_menu2 = 0x193,
        chs_poke_contest = 0x194,
        store_poke_contest = 0x195,
        show_poke_info = 0x196,
        store_poke_move = 0x197,
        check_poke_egg = 0x198,
        compare_poke_nick = 0x199,
        check_party_number_union = 0x19a,
        check_poke_party_health = 0x19b,
        check_poke_party_num_d_care = 0x19c,
        check_egg_union = 0x19d,
        underground_function = 0x19e,
        underground_function2 = 0x19f,
        underground_start = 0x1a0,
        take_money_d_care = 0x1a3,
        take_pokemon_d_care = 0x1a4,
        act_egg_day_c_man = 0x1a8,
        deact_egg_day_c_man = 0x1a9,
        set_var_poke_and_money_d_care = 0x1aa,
        check_money_d_care = 0x1ab,
        egg_animation = 0x1ac,
        set_var_poke_and_level_d_care = 0x1ae,
        set_var_poke_chosen_d_care = 0x1af,
        give_poke_d_care = 0x1b0,
        add_people2 = 0x1b1,
        remove_people2 = 0x1b2,
        mail_box = 0x1b3,
        check_mail = 0x1b4,
        show_record_list = 0x1b5,
        check_time = 0x1b6,
        check_id_player = 0x1b7,
        random_text_stored = 0x1b8,
        store_happy_poke = 0x1b9,
        store_happy_status = 0x1ba,
        set_var_data_day_care = 0x1bc,
        check_face_position = 0x1bd,
        store_poke_d_care_love = 0x1be,
        check_status_solaceon_event = 0x1bf,
        check_poke_party = 0x1c0,
        copy_pokemon_height = 0x1c1,
        set_variable_pokemon_height = 0x1c2,
        compare_pokemon_height = 0x1c3,
        check_pokemon_height = 0x1c4,
        show_move_info = 0x1c5,
        store_poke_delete = 0x1c6,
        store_move_delete = 0x1c7,
        check_move_num_delete = 0x1c8,
        store_delete_move = 0x1c9,
        check_delete_move = 0x1ca,
        setvar_move_delete = 0x1cb,
        cmd_1cc = 0x1cc,
        de_activate_leader = 0x1cd,
        hm_functions = 0x1cf,
        flash_duration = 0x1d0,
        defog_duration = 0x1d1,
        give_accessories = 0x1d2,
        check_accessories = 0x1d3,
        cmd_1d4 = 0x1d4,
        give_accessories2 = 0x1d5,
        check_accessories2 = 0x1d6,
        berry_poffin = 0x1d7,
        set_var_b_tower_chs = 0x1d8,
        battle_room_result = 0x1d9,
        activate_b_tower = 0x1da,
        store_b_tower_data = 0x1db,
        close_b_tower = 0x1dc,
        call_b_tower_functions = 0x1dd,
        random_team_b_tower = 0x1de,
        store_prize_num_b_tower = 0x1df,
        store_people_id_b_tower = 0x1e0,
        call_b_tower_wire_function = 0x1e1,
        store_p_chosen_wire_b_tower = 0x1e2,
        store_rank_data_wire_b_tower = 0x1e3,
        cmd_1e4 = 0x1e4,
        random_event = 0x1e5,
        check_sinnoh_pokedex = 0x1e8,
        check_national_pokedex = 0x1e9,
        show_sinnoh_sheet = 0x1ea,
        show_national_sheet = 0x1eb,
        cmd_1ec = 0x1ec,
        store_trophy_pokemon = 0x1ed,
        cmd_1ef = 0x1ef,
        cmd_1f0 = 0x1f0,
        check_act_fossil = 0x1f1,
        cmd_1f2 = 0x1f2,
        cmd_1f3 = 0x1f3,
        check_item_chosen = 0x1f4,
        compare_item_poke_fossil = 0x1f5,
        check_pokemon_level = 0x1f6,
        check_is_pokemon_poisoned = 0x1f7,
        pre_wfc = 0x1f8,
        store_furniture = 0x1f9,
        copy_furniture = 0x1fb,
        set_b_castle_function_id = 0x1fe,
        b_castle_funct_return = 0x1ff,
        cmd_200 = 0x200,
        check_effect_hm = 0x201,
        great_marsh_function = 0x202,
        battle_poke_colosseum = 0x203,
        warp_last_elevator = 0x204,
        open_geo_net = 0x205,
        great_marsh_bynocule = 0x206,
        store_poke_colosseum_lost = 0x207,
        pokemon_picture = 0x208,
        hide_picture = 0x209,
        cmd_20a = 0x20a,
        cmd_20b = 0x20b,
        cmd_20c = 0x20c,
        setvar_mt_coronet = 0x20d,
        cmd_20e = 0x20e,
        check_quic_trine_coordinates = 0x20f,
        setvar_quick_train_coordinates = 0x210,
        move_train_anm = 0x211,
        store_poke_nature = 0x212,
        check_poke_nature = 0x213,
        random_hallowes = 0x214,
        start_amity = 0x215,
        cmd_216 = 0x216,
        cmd_217 = 0x217,
        chs_r_s_poke = 0x218,
        ...
        check_s_poke = 0x21a,
        cmd_21b = 0x21b,
        act_swarm_poke = 0x21c,
        cmd_21d = 0x21d,
        cmd_21e = 0x21e,
        check_move_remember = 0x21f,
        cmd_220 = 0x220,
        store_poke_remember = 0x221,
        cmd_222 = 0x222,
        store_remember_move = 0x223,
        teach_move = 0x224,
        check_teach_move = 0x225,
        set_trade_id = 0x226,
        check_pokemon_trade = 0x228,
        trade_chosen_pokemon = 0x229,
        stop_trade = 0x22a,
        cmd_22b = 0x22b,
        close_oak_assistant_event = 0x22c,
        check_nat_pokedex_status = 0x22d,
        check_ribbon_number = 0x22f,
        check_ribbon = 0x230,
        give_ribbon = 0x231,
        setvar_ribbon = 0x232,
        check_happy_ribbon = 0x233,
        check_pokemart = 0x234,
        check_furniture = 0x235,
        cmd_236 = 0x236,
        check_phrase_box_input = 0x237,
        check_status_phrase_box = 0x238,
        decide_rules = 0x239,
        check_foot_step = 0x23a,
        heal_pokemon_animation = 0x23b,
        store_elevator_direction = 0x23c,
        ship_animation = 0x23d,
        cmd_23e = 0x23e,
        store_phrase_box1_w = 0x243,
        store_phrase_box2_w = 0x244,
        setvar_phrase_box1_w = 0x245,
        store_mt_coronet = 0x246,
        check_first_poke_party = 0x247,
        check_poke_type = 0x248,
        check_phrase_box_input2 = 0x249,
        store_und_time = 0x24a,
        prepare_pc_animation = 0x24b,
        open_pc_animation = 0x24c,
        close_pc_animation = 0x24d,
        check_lotto_number = 0x24e,
        compare_lotto_number = 0x24f,
        setvar_id_poke_boxes = 0x251,
        cmd_250 = 0x250,
        check_boxes_number = 0x252,
        stop_great_marsh = 0x253,
        check_poke_catching_show = 0x254,
        close_catching_show = 0x255,
        check_catching_show_records = 0x256,
        sprt_save = 0x257,
        ret_sprt_save = 0x258,
        elev_lg_animation = 0x259,
        check_elev_lg_anm = 0x25a,
        elev_ir_anm = 0x25b,
        stop_elev_anm = 0x25c,
        check_elev_position = 0x25d,
        galact_anm = 0x25e,
        galact_anm2 = 0x25f,
        main_event = 0x260,
        check_accessories3 = 0x261,
        act_deoxis_form_change = 0x262,
        change_form_deoxis = 0x263,
        check_coombe_event = 0x264,
        act_contest_map = 0x265,
        cmd_266 = 0x266,
        pokecasino = 0x267,
        check_time2 = 0x268,
        regigigas_anm = 0x269,
        ...
        check_regi = 0x26b,
        check_massage = 0x26c,
        unown_message_box = 0x26d,
        check_p_catching_show = 0x26e,
        cmd_26f = 0x26f,
        shaymin_anm = 0x270,
        thank_name_insert = 0x271,
        setvar_shaymin = 0x272,
        setvar_accessories2 = 0x273,
        cmd_274 = 0x274,
        check_record_casino = 0x275,
        check_coins_casino = 0x276,
        srt_random_num = 0x277,
        check_poke_level2 = 0x278,
        cmd_279 = 0x279,
        league_castle_view = 0x27a,
        cmd_27b = 0x27b,
        setvar_amity_pokemon = 0x27c,
        cmd_27d = 0x27d,
        check_first_time_v_shop = 0x27e,
        cmd_27f = 0x27f,
        setvar_id_number = 0x280,
        cmd_281 = 0x281,
        setvar_unk = 0x282,
        cmd_283 = 0x283,
        check_ruin_maniac = 0x284,
        check_turn_back = 0x285,
        check_ug_people_num = 0x286,
        check_ug_fossil_num = 0x287,
        check_ug_traps_num = 0x288,
        check_poffin_item = 0x289,
        check_poffin_case_status = 0x28a,
        unk_funct2 = 0x28b,
        pokemon_party_picture = 0x28c,
        act_learning = 0x28d,
        set_sound_learning = 0x28e,
        check_first_time_champion = 0x28f,
        choose_poke_d_care = 0x290,
        store_poke_d_care = 0x291,
        cmd_292 = 0x292,
        check_master_rank = 0x293,
        show_battle_points_box = 0x294,
        hide_battle_points_box = 0x295,
        update_battle_points_box = 0x296,
        take_b_points = 0x299,
        check_b_points = 0x29a,
        cmd_29c = 0x29c,
        choice_multi = 0x29d,
        h_m_effect = 0x29e,
        camera_bump_effect = 0x29f,
        double_battle = 0x2a0,
        apply_movement2 = 0x2a1,
        cmd_2a2 = 0x2a2,
        store_act_hero_friend_code = 0x2a3,
        store_act_other_friend_code = 0x2a4,
        choose_trade_pokemon = 0x2a5,
        chs_prize_casino = 0x2a6,
        check_plate = 0x2a7,
        take_coins_casino = 0x2a8,
        check_coins_casino2 = 0x2a9,
        compare_phrase_box_input = 0x2aa,
        store_seal_num = 0x2ab,
        activate_mystery_gift = 0x2ac,
        check_follow_battle = 0x2ad,
        cmd_2af = 0x2af,
        cmd_2b0 = 0x2b0,
        cmd_2b1 = 0x2b1,
        cmd_2b2 = 0x2b2,
        setvar_seal_random = 0x2b3,
        darkrai_function = 0x2b5,
        cmd_2b6 = 0x2b6,
        store_poke_num_party = 0x2b7,
        store_poke_nickname = 0x2b8,
        close_multi_union = 0x2b9,
        check_battle_union = 0x2ba,
        cmd_2_b_b = 0x2bb,
        check_wild_battle2 = 0x2bc,
        wild_battle2 = 0x2bd,
        store_trainer_card_star = 0x2be,
        bike_ride = 0x2bf,
        cmd_2c0 = 0x2c0,
        show_save_box = 0x2c1,
        hide_save_box = 0x2c2,
        cmd_2c3 = 0x2c3,
        show_b_tower_some = 0x2c4,
        delete_saves_b_factory = 0x2c5,
        spin_trade_union = 0x2c6,
        check_version_game = 0x2c7,
        show_b_arcade_recors = 0x2c8,
        eterna_gym_anm = 0x2c9,
        floral_clock_animation = 0x2ca,
        check_poke_party2 = 0x2cb,
        check_poke_castle = 0x2cc,
        act_team_galactic_events = 0x2cd,
        choose_wire_poke_b_castle = 0x2cf,
        cmd_2d0 = 0x2d0,
        cmd_2d1 = 0x2d1,
        cmd_2d2 = 0x2d2,
        cmd_2d3 = 0x2d3,
